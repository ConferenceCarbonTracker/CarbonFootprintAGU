...
proj = ccrs.AzimuthalEquidistant(central_latitude=PEKloc[0],central_longitude=PEKloc[1])
ax = fig.add_subplot(1,1,1,projection=proj)

ax.set_xlim(-5e6,2.7e6)
ax.set_ylim(-4.5e6,1e6)
...
ax.text(-2.15e6,0,"2,000km",**alignment,alpha=0.5,rotation=-90)
ax.text(-3.2e6,-2.6e6,"4,000km",**alignment,alpha=0.5,rotation=-50)
...
ax.scatter(PEKloc[1],PEKloc[0],100,c="lightgreen",marker="*",label="Beijing",zorder=10,edgecolor="k",lw=0.7,transform=ccrs.Geodetic())
